...
const EmployeeJoinForm = () => {
  ...
  const onSubmit = async (data) => {
    try {
      const { email, password, displayName, dateOfBirth, photoURL, role, company } =
        data;
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
              <div className="grid grid-cols-1 gap-2">
                ...
                <div className="flex justify-between">
                  <div className="form-control">
                    <label className="label">
                      <span className="label-text font-semibold">Role <span className="text-red-500">*</span></span>
                    </label>
                  ...
                  <div className="form-control">
                    <label className="label">
                      <span className="label-text font-semibold">Work in (optional) </span>
                    </label>
                    <div className="flex items-center space-x-2">
                      <input
                        type="checkbox"
