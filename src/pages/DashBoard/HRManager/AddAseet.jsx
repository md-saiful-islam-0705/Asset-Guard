      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="form-control w-full my-6">
          <label className="label">
            <span className="label-text font-semibold">Product Name <span className="text-red-500">*</span> </span>
          </label>
          <input
            type="text"
        ...
        <div className="form-control w-full my-6">
          <label className="label">
            <span className="label-text font-semibold">Product Type <span className="text-red-500">*</span> </span>
          </label>
          <select
        ...
        <div className="form-control w-full mb-2">
          <label className="label">
            <span className="label-text font-semibold">Product Quantity <span className="text-red-500">*</span> </span>
          </label>
          <input
            type="number"
        ...
        <div className="form-control w-full mb-2">
          <label className="label">
            <span className="label-text font-semibold">Product Image <span className="text-red-500">*</span> </span>
          </label>
          <input
            type="file"
